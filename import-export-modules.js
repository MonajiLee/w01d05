...
// They want to be able to input numerical data and sort it accordingly. For this application, 
// you're going to need a custom module for sorting data.

// With your new knowledge of importing and exporting modules, as well as creating private 
// functions and variables, do the following:

// Create a module that exports a function that takes a number as a parameter and stores it 
// in a list. The list should not be accessible from outside the module.
